...
public:
    ...
    Main()
    {
        ...
        m_directionalLight.DiffuseIntensity = 1.5;
        m_directionalLight.Direction = Vector3f(0.0f, 0.0, 1);
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "FreakSnow33")) return 1;
