...
public:
    ...
    Tutorial32()
    {
        ...
        m_pEffect = NULL;
        m_scale = 0.0f;
        m_directionalLight.Color = Vector3f(0.6, 1.0f, 1.0f);
        m_directionalLight.AmbientIntensity = 0.1;
        m_directionalLight.DiffuseIntensity = 1;
        m_directionalLight.Direction = Vector3f(0, -1, 0);
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "FreakShow32")) {
        return 1;
    }
